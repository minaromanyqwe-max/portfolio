    ...
    <section id="about" className="relative mb-40 pt-24 px-4 overflow-hidden">
      ...
      <div className="flex flex-col items-center mb-20 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-blue-400 text-xs font-bold uppercase tracking-[0.2em] mb-6 backdrop-blur-md"
        >
        ...
        <motion.h2
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-5xl md:text-6xl font-black mb-6 tracking-tight text-white"
        >
          <GradientText
      ...
      <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start max-w-7xl mx-auto">
        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed font-light">
              As a passionate <span className="text-white font-medium">Front-End Developer</span>, I specialize in building high-performance web applications that bridge the gap between complex logic and <span className="text-blue-400">intuitive user experiences</span>.
            </p>
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed font-light">
        ...
        >
          <div className="relative p-1 rounded-[2.5rem] bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-transparent">
            <div className="bg-zinc-950 rounded-[2.4rem] p-8 md:p-10 border border-white/5 space-y-8">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-blue-500/10 flex items-center justify-center">
                  <Laptop className="text-blue-400 w-6 h-6" />
                </div>
                <div>
                  <h4 className="text-white font-bold text-xl">Core Tech Stack</h4>
                  <p className="text-gray-500 text-sm">Tools I use daily</p>
                </div>
              </div>

              <div className="grid gap-4">
                {coreSkills.map((skill, i) => (
                  <div key={i} className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors group">
